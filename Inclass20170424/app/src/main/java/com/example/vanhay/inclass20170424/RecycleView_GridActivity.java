...
public class RecycleView_GridActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycle_view__grid);
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(RecycleView_GridActivity.this,2);
        itemAdapter = new ItemAdapter(RecycleView_GridActivity.this,itemArrayList,R.layout.layout_row_with_card);
