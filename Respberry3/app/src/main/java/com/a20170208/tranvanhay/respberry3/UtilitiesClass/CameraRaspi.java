...
public class CameraRaspi {
    ...
    private static class InstanceHolder {
        private static CameraRaspi mCamera = new CameraRaspi();
    }

    public static CameraRaspi getInstance() {
    ...
    public void initializeCamera(Context context,
        ...
        if (camIds.length < 1) {
            ...
            Log.d(TAG, "Numbers camera found: " +camIds.length);
        }
        String id = camIds[0];
        ...
        try {
            ...
            Log.d(TAG, "Accessed camera: " + id);
        } catch (CameraAccessException cae) {
            Log.d(TAG, "Camera access exception", cae);
        }
        catch (SecurityException se){
            Log.d(TAG,"Has exception: " + se);
        }
    }
